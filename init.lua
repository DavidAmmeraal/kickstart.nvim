...
vim.keymap.set('n', ']d', '<cmd>Lspsaga diagnostic_jump_prev<CR>', { desc = 'Go to prev diagnostic' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('v', '<leader>sv', live_grep_args_shortcuts.grep_visual_selection, { desc = '[S]earch [V]isual Selection' })
